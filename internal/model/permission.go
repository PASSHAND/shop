...
type PermissionCreateOutput struct {
	PermissionId uint `json:"role_id"`
}
...
type PermissionGetListOutputItem struct {
	//Permission *PermissionListItem `json:"admin"`
	//Category *PermissionListCategoryItem `json:"category"`
	//User     *PermissionListUserItem     `json:"user"`
