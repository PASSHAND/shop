...
type GoodsOptionsCommonAddUpdate struct {
	GoodsId uint   `json:"goodsId"   description:"主商品id"`
...
type GoodsOptionsUpdateReq struct {
	g.Meta `path:"/goods/options/update/{Id}" method:"post" tags:"商品规格" summary:"修改商品规格接口"`
	Id     uint `json:"id"         v:"min:1#请选择需要修改的内容" dc:"商品规格Id"`
	GoodsOptionsCommonAddUpdate
}
